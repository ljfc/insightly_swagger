...
module SwaggerClient
  class OrganisationsApi
    ...
    def add_activity_set_assignment_with_http_info(id, api_activity_set_assignment, opts = {})
      ...
      # resource path
      local_var_path = "/Organisations/{id}/ActivitySetAssignment".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def add_address_with_http_info(id, api_address, opts = {})
      ...
      # resource path
      local_var_path = "/Organisations/{id}/Addresses".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def add_contact_info_with_http_info(id, api_contact_info, opts = {})
      ...
      # resource path
      local_var_path = "/Organisations/{id}/ContactInfos".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def add_date_with_http_info(id, api_date, opts = {})
      ...
      # resource path
      local_var_path = "/Organisations/{id}/Dates".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def add_file_attachment_with_http_info(id, file, opts = {})
      ...
      # resource path
      local_var_path = "/Organisations/{id}/FileAttachments".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def add_follow_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = "/Organisations/{id}/Follow".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def add_link_with_http_info(id, api_link, opts = {})
      ...
      # resource path
      local_var_path = "/Organisations/{id}/Links".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def add_note_with_http_info(id, api_note, opts = {})
      ...
      # resource path
      local_var_path = "/Organisations/{id}/Notes".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def add_organisation_with_http_info(api_organisation, opts = {})
      ...
      # resource path
      local_var_path = "/Organisations".sub('{format}','json')
    ...
    def add_organisation_link_with_http_info(id, api_link, opts = {})
      ...
      # resource path
      local_var_path = "/Organisations/{id}/OrganisationLinks".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def add_tag_with_http_info(id, api_tag, opts = {})
      ...
      # resource path
      local_var_path = "/Organisations/{id}/Tags".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def delete_address_with_http_info(id, address_id, opts = {})
      ...
      # resource path
      local_var_path = "/Organisations/{id}/Addresses/{addressId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'addressId' + '}', address_id.to_s)
    ...
    def delete_contact_info_with_http_info(id, contact_info_id, opts = {})
      ...
      # resource path
      local_var_path = "/Organisations/{id}/ContactInfos/{contactInfoId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'contactInfoId' + '}', contact_info_id.to_s)
    ...
    def delete_custom_field_with_http_info(id, custom_field_id, opts = {})
      ...
      # resource path
      local_var_path = "/Organisations/{id}/CustomFields/{customFieldId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'customFieldId' + '}', custom_field_id.to_s)
    ...
    def delete_date_with_http_info(id, date_id, opts = {})
      ...
      # resource path
      local_var_path = "/Organisations/{id}/Dates/{dateId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'dateId' + '}', date_id.to_s)
    ...
    def delete_image_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = "/Organisations/{id}/Image".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def delete_link_with_http_info(id, link_id, opts = {})
      ...
      # resource path
      local_var_path = "/Organisations/{id}/Links/{linkId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'linkId' + '}', link_id.to_s)
    ...
    def delete_organisation_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = "/Organisations/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def delete_organisation_link_with_http_info(id, link_id, opts = {})
      ...
      # resource path
      local_var_path = "/Organisations/{id}/OrganisationLinks/{linkId}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'linkId' + '}', link_id.to_s)
    ...
    def delete_tag_with_http_info(id, tag_name, opts = {})
      ...
      # resource path
      local_var_path = "/Organisations/{id}/Tags/{tagName}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'tagName' + '}', tag_name.to_s)
    ...
    def get_emails_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = "/Organisations/{id}/Emails".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def get_events_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = "/Organisations/{id}/Events".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [BOOLEAN] :brief Optional, true if response should only contain top level properties of the organisation. (default to false)
    ...
    def get_organisations_by_search_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/Organisations/Search".sub('{format}','json')
    ...
    def get_tasks_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = "/Organisations/{id}/Tasks".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def update_custom_field_with_http_info(id, api_custom_field, opts = {})
      ...
      # resource path
      local_var_path = "/Organisations/{id}/CustomFields".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def update_image_with_http_info(id, filename, file, opts = {})
      ...
      # resource path
      local_var_path = "/Organisations/{id}/Image/{filename}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'filename' + '}', filename.to_s)
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [BOOLEAN] :brief Optional, true if you wish to do a partial update containing only top level properties of the Organisation. When true, all sub-collections are ignored. (default to false)
    # @return [InlineResponse20028]
