...
module SwaggerClient
  ...
  class InlineResponse20010
    ...
    def hash
      [end_date_utc, owner_user_id, details, all_day, eventlinks, date_created_utc, location, event_id, reminder_date_utc, reminder_sent, date_updated_utc, publicly_visible, title, start_date_utc].hash
    end
