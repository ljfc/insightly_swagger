...
module SwaggerClient
  ...
  class InlineResponse20013
    ...
    def hash
      [visible_team_id, note_id, owner_user_id, body, visible_user_ids, visible_to, notelinks, date_updated_utc, date_created_utc, link_subject_type, link_subject_id, title].hash
    end
